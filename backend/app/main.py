...
from app.api import subjects, visits, files, assessments, export, auth, templates, users, studies
...
app.include_router(studies.router, prefix="/api/v1/studies", tags=["研究管理"])
